        ...
        <View style={styles.settingsCon}>
          <View style={styles.settingsItems}>
            ...
            <Text
              ...
              Pour votre confort de lecture, vous pouvez conserver le réglage de
              votre appareil ou personnaliser la taille de la police dans les
              articles en déplaçant le curseur.
            </Text>
          </View>
          <Divider />
          ...
          <View style={styles.fontResizeSlide}>
            ...
            <Slider
              ...
              minimumTrackTintColor={isDark ? COLORS.dark.textSoft : '#000000'}
          ...
          <View style={styles.fontResizeBox}>
            ...
            <Text
              ...
              Un grand journal, c'est rebâtir tous les jours un chateau de sable
              avec une petite cuillère. -Hubert Beuve-Mery
            </Text>
          </View>
        </View>
      </View>
