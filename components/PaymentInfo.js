      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.details}>
            BANK NAME: <Text style={styles.subDetails}>Nil</Text>
          </Text>
          <Text style={styles.details} selectable>
            BRANCH: <Text style={styles.subDetails}>Nil</Text>
          </Text>
          <Text style={styles.details} selectable>
            ACCOUNT NAME: <Text style={styles.subDetails}>Nil</Text>
          </Text>
          <Text style={styles.details} selectable>
            ACCOUNT NUMBER: <Text style={styles.subDetails}>Nil</Text>
          </Text>
          ...
          <Text style={styles.details}>
            BANK NAME:{' '}
            <Text style={styles.subDetails}>Diamond/Access bank</Text>
          </Text>
          <Text style={styles.details} selectable>
            ACCOUNT NAME:{' '}
            <Text style={styles.subDetails}>ESGT Educational Services</Text>
          </Text>
          <Text style={styles.details} selectable>
            ACCOUNT NUMBER: <Text style={styles.subDetails}>0094442839</Text>
          </Text>
